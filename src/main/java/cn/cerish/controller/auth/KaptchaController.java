...
public class KaptchaController {
    ...
    public void defaultKaptcha(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
        ...
        try {
            ...
            Object verificationCode = httpServletRequest.getSession().getAttribute("verificationCode");
    ...
    @ApiOperation(value = "校对图形验证码")
    @PostMapping("/checkVerificationCode")
    public Boolean checkVerificationCode(@RequestParam(value = "verificationCode") String verificationCode, HttpServletRequest httpServletRequest) {
